...
export function Footer() {
  ...
  const siteName = 'libribooks.com';
  const tagline = 'Your friendly corner of the internet for discovering amazing books and sharing the love of reading.';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
             ...
             <div className="flex justify-start gap-4">
                ...
                <Link href="#" className="text-muted-foreground hover:text-foreground transition-colors"><Facebook className="h-5 w-5" /></Link>
                <Link href="#" className="text-muted-foreground hover:text-foreground transition-colors"><PinterestIcon /></Link>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              {quickLinks.map((link: { href: string; label: string }) => (
                <li key={link.href}>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              {legalLinks.map((link: { href: string; label: string }) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                    {link.label}
                  </Link>
