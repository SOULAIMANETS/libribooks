    ...
    <main className="flex-1 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          ...
          {pageData.structured_content?.contactEmail && (
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a href={`mailto:${pageData.structured_content.contactEmail}`} className="text-muted-foreground hover:text-primary transition-colors">
                  {pageData.structured_content.contactEmail}
                </a>
              </div>
            </div>
          )}
          {pageData.structured_content?.contactPhone && (
            <div className="flex items-center gap-4">
              <div className="bg-primary/10 p-3 rounded-full">
              ...
              <div>
                ...
                <p className="text-muted-foreground">{pageData.structured_content.contactPhone}</p>
              </div>
            </div>
          )}
          {pageData.structured_content?.officeAddress && (
            <div className="flex items-center gap-4">
              <div className="bg-primary/10 p-3 rounded-full">
              ...
              <div>
                ...
                <p className="text-muted-foreground">{pageData.structured_content.officeAddress}</p>
              </div>
            </div>
          )}
        </div>
