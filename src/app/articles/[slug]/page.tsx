...
import { articleService, skillService } from '@/lib/services';
...
export default async function ArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  // Fetch parent skill if this article belongs to a skill
  const parentSkill = article.skillSlug ? await skillService.getBySlug(article.skillSlug) : null;
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 w-full py-12">
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Breadcrumb for articles belonging to a skill */}
          {parentSkill && (
            <div className="mb-6">
              <Link
